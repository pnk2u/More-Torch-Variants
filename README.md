# <img width='24' src="./src/main/resources/icon.png"> More Torch Variants
> ![Mod Icon](https://raw.githubusercontent.com/pnk2u/resources/main/ModProjects/More-Torch-Variants/pres/logo/logo_c.png)
>
...
<!--CHANGELOG:START-->
### 1.2.1:
- `1.21.4(-10)`: Fix vanilla Copper Torch recipe and several load condition errors leading to log spam when used in `1.21.4(-8)`
## 1.2.0:
